...
namespace IVISS
{
    public partial class frmLoginV1 : MaterialForm, ILogin
    {
        #region Declaration
        ...
        private void chkAgreeTo_CheckedChanged(object sender, EventArgs e)
        {
            pnlLoginMain.Enabled = this.chkAgreeTo.Checked;
            lblAgreementError.Visible = !this.chkAgreeTo.Checked;
            if (this.chkAgreeTo.Checked)
            {
                txtUsername.Focus();
            }
        }
