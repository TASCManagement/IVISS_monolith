...
namespace IVISS
{
    public partial class Main : Form, IMain
    {
            ...
            Task t = Task.Run(() =>
            {
                ...
                //}
                    ...
                    if (File.Exists(path + @"\outPutVer.jpg"))
                        this.pBoxStitch.Image = Image.FromFile(path + @"\outPutVer.jpg");
                    else
        ...
        private void btnHigh_Click(object sender, EventArgs e)
        {
            ...
            Task T2 = Task.Run(() =>
            {
                m_SelectedImage = "C:\\IVISSTemp\\_high.jpg";
                
                if (File.Exists(m_SelectedImage))
                {
                    BeginInvoke((MethodInvoker)delegate
                    {
                        pBoxComparison.Image = null;
                        pBoxComparison.Image = Image.FromFile(m_SelectedImage);
                    });
                }
            });
        }
        ...
        private void btnMedium_Click(object sender, EventArgs e)
        {
            ...
            Task T2 = Task.Run(() =>
            {
                m_SelectedImage = "C:\\IVISSTemp\\_medium.jpg";
        ...
        private void btnLow_Click(object sender, EventArgs e)
        {
            ...
            Task T2 = Task.Run(() =>
            {
                m_SelectedImage = "C:\\IVISSTemp\\_low.jpg";
        ...
        private void btnOriginal_Click(object sender, EventArgs e)
        {
            ...
            Task T2 = Task.Run(() =>
            {
                m_SelectedImage = "C:\\IVISSTemp\\photoshop2.jpg";
