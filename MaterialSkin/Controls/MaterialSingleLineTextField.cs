...
namespace MaterialSkin.Controls
{
    public class MaterialSingleLineTextField : Control, IMaterialControl
    {
        ...
        public System.Windows.Forms.HorizontalAlignment TextAlign { get { return _baseTextBox.TextAlign; } set { _baseTextBox.TextAlign = value; } }
        ...
        public MaterialSingleLineTextField()
        {
            ...
            BackColorChanged += (sender, args) =>
            {
                ...
                _baseTextBox.ForeColor = base.ForeColor;
            };
